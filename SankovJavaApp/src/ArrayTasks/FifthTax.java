...
public class FifthTax {
	...
	public static void main(String[] args) {
		...
		min = arrayRandom[0]; // we appropriate to an element under an index 0
								// the minimum value
		for (int i = 0; i < 15; i++) {
		...
		System.out.println("\nMin element: " + min);// print to the screen the
													// value of minimum element
													// of array
		System.out.print("Index: " + index);// print to the screen the index of
