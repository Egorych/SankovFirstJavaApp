...
public class ThirdTask {
	...
	public static void main(String[] args) {
		int[] listOfInitialization = { 1, 2, 3, 4, 4, 5, 3, 3, 2, 1, 2, 3, 6 }; // list
																				// of
																				// initialization
		...
		for (int i = 0; i < 5; i++) {
			inputFromKeypad[i] = elementOfArray.nextInt();// appropriate into
															// the array the
															// values which
															// entered from the
															// keyboard
		...
		for (int i = 0; i < 5; i++) {
			System.out.print(inputFromKeypad[i] + " "); //// print to the screen
														//// the elements of
														//// array
		}
