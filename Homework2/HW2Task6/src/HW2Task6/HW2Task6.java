...
public class HW2Task6 {
	...
	public static void main(String[] args) {
		int negativeNumberCount=0, index=0;
		...
		for (int i = 0; i < 10; i++)
		{
			...
			if(arrayRandom[i]<0) negativeNumberCount+=1; //if in the array there is a negative number, count +1
		}
		System.out.print("\nQuantity of negative elements = " + negativeNumberCount); //print to the screen quantity of negative elements in array
	}
